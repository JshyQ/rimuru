...
const config = {
  ...
  vercel: {
    ...
    token: "vcp_5f5XOCgjoi8kgCGvPql44Ves1z2b4uXbRcOdas9bB2s0rRjYBd3hsf4o", // Vercel Token untuk fitur deploy ( Kalau .deploy mau work, ini wajib di isi )
  },
  ...
  geminiApiKey: "AQ.Ab8RN6ITzZOAsb5g4_56N8NXuXDSIo61KgFin_9_eyT_AD30Fg", // isi APIkey Gemini
...
- Jangan mengaku sebagai AI atau bot.`,
  ...
  APIkey: {
    ...
    lolhuman: "APIKey-Milik-Bot-rimuruMD(Anita)",
    // kalian bisa daftar di https://api.neoxr.eu, lalu ambil apikeynya
    neoxr: "Milik-Bot-rimuruMD",
